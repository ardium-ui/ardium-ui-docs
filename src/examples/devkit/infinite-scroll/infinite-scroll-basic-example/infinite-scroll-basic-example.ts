...
@Component({
  selector: 'infinite-scroll-basic-example',
  templateUrl: './infinite-scroll-basic-example.html',
  styleUrl: './infinite-scroll-basic-example.scss',
  standalone: true,
  imports: [ArdiumInfiniteScrollModule],
})
export class InfiniteScrollBasicExample {
